using ShapeUp.Core.ShapeEditor.PolyBoolCS;
using System.Collections.Generic;
using PolyboolPolygon = ShapeUp.Core.ShapeEditor.PolyBoolCS.Polygon;
using Region = ShapeUp.Core.ShapeEditor.PolyBoolCS.PointList;
