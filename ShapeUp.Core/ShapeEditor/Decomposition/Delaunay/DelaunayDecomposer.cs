...
using ShapeUp.Core.ShapeEditor.Delaunay.Delaunay;
using ShapeUp.Core.ShapeEditor.Delaunay.Delaunay.Sweep;
using System.Collections.Generic;
using UnityEngine;
using Vertices = ShapeUp.Core.ShapeEditor.Polygon;

namespace ShapeUp.Core.ShapeEditor.Delaunay
{
    /// <summary>
