...
namespace ShapeUp.Core.ShapeEditor
{
    ...
    public partial class Segment : ISelectable
    {
        ...
        /// <summary>
        /// For <see cref="System.Text.Json"/> (<see cref="UnityEngine.JsonUtility"/> shim) only;
        /// <see cref="Shape.Validate"/> rewires <see cref="shape"/>, <see cref="generator"/>, and list links.
        /// </summary>
        [JsonConstructor]
        private Segment()
        {
